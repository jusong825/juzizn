<template>
  <div>
    <div style="margin-top: 10px">
      ...
      <el-row :gutter="10">
        <!--    图片-->
        <el-col :span="8" style="z-index: 9999;">
          <div class="spec-preview">
            <img :src="mainImg" alt=""/>
            <div class="event" @mousemove="handler"></div>
            <div class="big">
              <img :src="mainImg" ref="big" alt=""/>
            </div>
            <!-- 遮罩层 -->
          ...
          <el-card>
            <div
                style="display: flex;  flex-wrap: wrap; flex-direction: row; justify-content: flex-start">
              <div style="flex: 1;" v-for="(item, index) in goods.imgs" :key="item.id">
        ...
        <el-col :span="16">
          <el-card>
            <div style="text-align: right;margin: 13px 0">
              <div style="display: inline-block; cursor: pointer;" @click="collect">
                <img :src="collectActiveIcon" alt="收藏" style="width: 25px; ">
                <span style="position: relative; bottom: 3px; font-size: 16px; left: 5px; color: #666">收藏</span>
              </div>
              <div style="display: inline-block; cursor: pointer; margin-left: 20px" @click="praise">
                <img :src="praiseActiveIcon" alt="点赞" style="width: 25px; ">
                <span style="position: relative; bottom: 2px; color: #666; margin-left: 5px;font-size: 16px">{{ goods.praise }}</span>
              </div>
            </div>
            <div style="padding: 15px 0; font-size: 20px; font-weight: bold">{{ goods.name }}</div>
            <div style="padding: 15px 0; color: #666; font-size: 14px">{{ goods.description }}</div>
            <div style="padding: 15px 0; color: #999;">
              <span>上架时间</span>
            ...
            <div style="padding: 10px 0; color: #999;">
              ...
              <span style="margin-left: 20px; color: #666">
                由“橘子智能平台”发货，并提供售后服务。 23:55前完成下单，预计明天可送达
              </span>
            </div>

            <div style="margin-top: 20px; padding: 10px 0;display: flex">
              <el-input-number v-model="num" :min="1" :max="10" label="购买数量"
                               style="width: 100px;margin-top: 10px; "></el-input-number>
              <div style="width: 50%;display: flex">
                <div class="collection btn" @click="addCart()">
                  <img :src="cartIcon" style="width: 20px; position: absolute; left: 20px; top:11px;" alt="">
                  <p class="but-title" style="color: #111111">加入购物车</p>
                </div>
                <div class="buy btn" @click="buyNow()">
                  <p class="but-title">立即购买</p>
                </div>
              </div>
            </div>
          </el-card>
...
export default {
  ...
  data() {
    return {
      ...
      address: '',
      mainImg: '',
      cartIcon: require('../../assets/images/home/bag_1-0.png'),
      praiseActiveIcon: require("../../assets/点赞-激活.png"),
      collectActiveIcon: require("../../assets/images/home/rebrand-hearts.png"),
      num: 1,
      id: 1,
      user: {},
      goods: {imgs: []},
