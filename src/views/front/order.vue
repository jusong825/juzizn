        ...
        <el-table :data="tableData" stripe style="width: 100%">
          ...
          >
            <template slot-scope="scope">
              ...
              <el-button type="danger" @click="cancel(scope.row.id)" v-if="scope.row.state === '待付款'">取消
              </el-button>
              <el-button type="primary" @click="confirm(scope.row.id)" v-if="scope.row.state === '待收货'">确认收货
              </el-button>
              <el-popconfirm
